...
export const Ассистент = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Под приветствием три подсказки: пустое поле ввода не объясняет, о чём ассистента '
          + 'вообще можно спросить. Нажмите любую — она уходит как ваше сообщение, и на неё есть '
          + 'готовый ответ. Как только вы спросили сами, подсказки убираются. В шапке — новый '
          + 'диалог и история разговоров.',
      },
    },
  },
};
