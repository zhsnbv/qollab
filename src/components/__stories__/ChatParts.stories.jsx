...
export const ПустойЧат = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Переписки ещё нет: объясняем, что делать, а не пишем «пусто». Внизу — плашка про '
          + 'шифрование: пока сообщений нет, место свободно, а в начале живой переписки она '
          + 'занимала бы экран вместо самих сообщений.',
      },
    },
  },
};
