...
// Заголовки в одну строку и одинаковые по строю: разница между состояниями
// живёт в них, а подсказка у всех одна — делать всё равно нужно одно и то же.
export const DEAD_INVITE = {
  expired: { title: 'Срок ссылки истёк', hint: 'Попросите прислать новую' },
  revoked: { title: 'Ссылку отозвали', hint: 'Попросите прислать новую' },
  // MVP-состояние: бэкенд ещё не различает, отозвали ссылку или вышел срок
  invalid: { title: 'Ссылка не работает', hint: 'Попросите прислать новую' },
};
